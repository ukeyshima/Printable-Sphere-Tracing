const slic3rGcode = () => {
    const date = new Date();
    return {
        header: `; generated by Slic3r 1.3.0 on ${date.getFullYear()}-${date.getMonth() + 1}-${date.getDate()} at ${date.getHours()}:${date.getMinutes()}:${date.getSeconds()}
...
; filament used = 1875.3mm (13.3cm3)
